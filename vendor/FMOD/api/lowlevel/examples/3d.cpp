...
const float DISTANCEFOBJECT = 1.0f;          // Units per meter.  I.e feet would = 3.28.  centimeters would = 100.
...
int FMOD_Main()
{
    ...
    FMOD_VECTOR      listenerpos  = { 0.0f, 0.0f, -1.0f * DISTANCEFOBJECT };
    ...
    */
    result = system->set3DSettings(1.0, DISTANCEFOBJECT, 1.0f);
    ERRCHECK(result);
    ...
    */
    ...
    ERRCHECK(result);
    result = sound1->set3DMinMaxDistance(0.5f * DISTANCEFOBJECT, 5000.0f * DISTANCEFOBJECT);
    ERRCHECK(result);
    ...
    ERRCHECK(result);
    result = sound2->set3DMinMaxDistance(0.5f * DISTANCEFOBJECT, 5000.0f * DISTANCEFACTOR);
    ERRCHECK(result);
