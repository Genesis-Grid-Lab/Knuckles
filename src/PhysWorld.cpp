...
namespace Knuckles
{
PhysWorld::PhysWorld(Application *game) : mApplication(game) {}
...
void PhysWorld::TestPairwise(std::function<void(Object *, Object *)> f) {
...
void PhysWorld::TestSweepAndPrune(std::function<void(Object *, Object *)> f) {
  // Sort by min.x
